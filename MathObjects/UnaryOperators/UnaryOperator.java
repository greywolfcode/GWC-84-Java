...
/**
 * Basis for all unary operator objects
 */
public abstract class UnaryOperator extends MathObject
{
    private int presedence;
    private String associtivity;
    
    //Method for evaluating operator; unary operators take only 1 input
    public abstract Numbers evaluate(Numbers numOne);
